...
export function createThaliDescription(thali) {
  if (typeof thali !== "object" ||thali === null || typeof thali.name !== "string" ||
    typeof thali.isVeg !== "boolean" ||!Array.isArray(thali.items) ||
...
export function searchThaliMenu(thalis, query) {
  ...
  return thalis.filter(function(thali) {
    ...
    let nameMatch = thali.name.toLowerCase().includes(lowerQuery);

    
    let itemMatch = thali.items.some(function(item) {
